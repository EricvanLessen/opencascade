# opencascade
This is a fork of [opencascade.js-examples](https://github.com/donalffons/opencascade.js-examples)

OpenCascade.js now finally has a proper [homepage](https://ocjs.org/). All examples will be migrated there and this repository will be archived soon.
